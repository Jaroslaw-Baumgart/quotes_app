...
class QuoteEditor {
    ...
    init() {
        this.lighbox = document.querySelector("#lightbox");
    ...
    showEditor = async () => {
        this.lighbox.classList.toggle("active");
    ...
    processNewQuote = async () => {
        if(this.quoteText.value.length == 0 
    ...
    deleteQuote = async (id) => { console.log("delete quote");
